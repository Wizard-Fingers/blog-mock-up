  ...
  return (
    <div className="flex flex-col p-4 ">
      <div className="flex flex-row-reverse md:flex-row w-full pb-6">
        <img
          className="w-[12rem] h-[12rem] flex md:w-[18rem] md:h-[18rem] lg:w-[12rem] lg:h-[12rem] xl:w-[14.9rem] xl:h-[14.9rem] 2xl:w-[19rem] 2xl:h-[19.2rem] object-cover flex-none cursor-pointer"
          src={imageUrl}
          alt="/"
        />
